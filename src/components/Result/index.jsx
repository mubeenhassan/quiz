...
let resultPhaseTwo = {
  visual:
    "You have indicated that you have a visual processing style. In order to communicate your desire to break your trauma bond to your subconscious you need to take actions and practice techniques which will break the bond in a way that you can see happening. Your tendency to move, think and talk faster than most means that you have the capacity to access a lot of information quickly leaving you little time to really describe what is going on in your head. By incorporating diagrams, imagery and guided visualisations into your process you can start to gain clarity over what life looks like without your trauma bond and your mind will soon be as uncluttered as you like your desk to be.",
  auditory:
    "You have indicated that you have an auditory processing style. In order to communicate your desire to break your trauma bond to your subconscious you need to take actions and practice techniques which will break the bond in a way that you can hear happening. Your tendency to understand better by listening and talking means you can easily repeat both negative and positive conversations back to yourself with accuracy. This is important since it is within these words that the truth lies. By incorporating music, mantras and the spoken word into your process you can break your trauma bond in a way that facilitates the harmonious life you desire.",
  kinaesthetic:
    "You have indicated that you have a kinaesthetic processing style. In order to communicate your desire to break your trauma bond to your subconscious you need to take actions and practice techniques which will break the bond in a way that you can feel happening. Your tendency to memorise by trying, experiencing and walking through things means you are most interested in doing the things that 'feel right' to you. This is important since it is with actions that communicate your desire to sever the strands of your trauma bond you will truly feel free and able to breathe deeply again.",
  evens:
    "You have indicated that you have an even mix of all of the processing styles. This is excellent news as it means that in order to communicate your desire to break your trauma bond to your subconscious you can take a wide range of actions and practice techniques which will break the bond in a way that you can see, hear and feel happening. Your broad and open processing style means that you are able to understand and pay attention in many different settings and for long periods of time. You are a quick learner and your 'can-do' attitude will serve you well as you take your first steps to break your trauma bond.",
}
      ...
      <div className="find-out-main">
        <div className="find-out">
          ...
          <p>
            ...
            style and 3 things you can do today to start breaking your bond
          </p>
          <input
            type="name"
